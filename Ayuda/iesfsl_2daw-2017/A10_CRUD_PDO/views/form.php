...
<h2>Edición de Título</h2>
	...
	<form method=post class='form'>
		...
		<?=geterror($errores,'anyo')?>
                        <br>
		<p>
			<input class='btn btn-primary' type="submit" value="Actualizar" class='budtton'>
		<?php
		if(isset($id)) // Estamos en modificación
			echo "<a class='btn btn-cancel' href='view.php?id=$id' >Cancelar</a>";
		else
			echo "<a href='index.php' class='btn btn-cancel'>Cancelar</a>";
